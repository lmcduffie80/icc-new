    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy - IMPORTANT: Test thoroughly!
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://va.vercel-scripts.com https://js.stripe.com https://assets.apollo.io",
              "worker-src 'self' blob:",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https: http:",
              "font-src 'self' data:",
              "connect-src 'self' https://*.vercel.app https://vercel.live https://va.vercel-scripts.com https://vitals.vercel-insights.com https://accounts.google.com https://appleid.apple.com https://*.amazonaws.com https://api.stripe.com https://*.stripe.com https://assets.apollo.io https://api.apollo.io wss:",
