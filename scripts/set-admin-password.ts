...
async function setAdminPassword() {
  ...
  if (!email) {
    console.error('Usage: pnpm tsx scripts/set-admin-password.ts <email> [--generate-password]');
    console.error('');
    ...
    console.error('  pnpm tsx scripts/set-admin-password.ts admin@example.com');
    console.error('  pnpm tsx scripts/set-admin-password.ts admin@example.com --generate-password');
    process.exit(1);
  }
